...
export const UI = {
  ...
  anotherHint:  B("Another hint", "Nog 'n wenk"),
  noMoreHints:  B("That's all the hints", "Dis al die wenke"),
  skip:         B("Skip this one", "Slaan oor"),
  mapShort:     B("Map", "Kaart"),
  almost:       B("Almost — half marks", "Amper — halwe punte"),
  secondChance: B("Not that one — look again, you get a second try (half marks).",
                  "Nie daai een nie — kyk weer, jy kry 'n tweede kans (halwe punte)."),
  boostTitle:   B("Help mode is on", "Hulp-modus is aan"),
  boostBlurb:   B("Hints open by themselves and every question gives a second try.",
                  "Wenke maak vanself oop en elke vraag gee 'n tweede kans."),
  comeback:     B("Comeback! You kept trying and made it", "Comeback! Jy het aangehou probeer en dit gemaak"),
  watchFirst:   B("Watch one first", "Kyk eers een saam"),
  lessonAgain:  B("Watch the lesson again", "Kyk weer die les"),
  theMethod:    B("The method", "Die metode"),
  ...
  dragDown:     B("Drag the point onto the graph", "Trek die punt op die grafiek"),
  dragAcross:   B("Drag the point sideways onto the graph", "Trek die punt links of regs op die grafiek"),
  snapped:      B("On the graph!", "Op die grafiek!"),
  unlocked:     B("Nice — now answer it.", "Mooi — antwoord dit nou."),
  walkIt:       B("Walk the point from left to right — it will not go back", "Skuif die punt van links na regs — dit gaan nie terug nie"),
  walkAgain:    B("Walk it again", "Skuif dit weer"),
  climbing:     B("CLIMBING", "STYGEND"),
  descending:   B("DESCENDING", "DALEND"),
  atStart:      B("Start dragging", "Begin trek"),
  walkedAll:    B("You walked the whole graph", "Jy het die hele grafiek geskuif"),
  finishWalk:   B("Walk all the way to the right first", "Skuif eers heeltemal tot regs"),
  ...
  tapSockets:   B("Tap every place that needs a cut line", "Klik op elke plek wat 'n snylyn nodig het"),
